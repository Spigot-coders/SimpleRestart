  ...
  implements Listener
{
  ...
  {
    Bukkit.getConsoleSender().sendMessage(ChatColor.GRAY + "**** " + ChatColor.RED + "SimpleRestart" + ChatColor.YELLOW + " is now Enabled! - Version Using: " + ChatColor.RED + getDescription().getVersion() + ChatColor.GRAY + " ****");
    Bukkit.getConsoleSender().sendMessage(ChatColor.YELLOW + "               Made by: " + ChatColor.AQUA + "augesrob");
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
  {
    if ((sender instanceof Player))
    {
      ...
      if ((label.equalsIgnoreCase("sr")) && 
        (!this.cooldownrp.contains(player.getName())) && 
        (player.hasPermission("simplerestart.use"))) {
        if (args.length == 0)
        {
          player.sendMessage(ChatColor.RED + "************" + ChatColor.GOLD + ChatColor.BOLD + getConfig().getString("Name") + ChatColor.RED + "************");
          player.sendMessage("   ");
          player.sendMessage(ChatColor.GOLD + "- /sr [1-15-30-45-60][sec]" + ChatColor.GRAY + " (Server restart in seconds)");
          player.sendMessage("   ");
          player.sendMessage(ChatColor.GOLD + "- /sr [1-15-30-45-60][min]" + ChatColor.GRAY + " (Server restart in minutes)");
          player.sendMessage("   ");
          player.sendMessage(ChatColor.GOLD + "- /sr [1-12-24-48-72][hour]" + ChatColor.GRAY + " (Server restart in hours)");
          player.sendMessage("   ");
